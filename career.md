...
|---|---|---|---|---|
| Kiến thức | • Là sinh viên năm cuối hoặc đã tốt nghiệp Đại học chưa quá 02 năm, ưu tiên các chuyên ngành Công nghệ thông tin hoặc các chương trình đào tạo liên quan đến lập trình và kỹ thuật phần mềm|...| … |chưa|
| Kỹ năng | • Nắm vững kiến thức nền tảng về cấu trúc dữ liệu, thuật toán và thành thạo ít nhất một ngôn ngữ lập trình (Java, C++, Python,...) |Có nền tảng tốt về lập trình, tư duy giải quyết vấn đề, Data Structures & Algorithms.Có kinh nghiệm tốt với Java/Spring Boot, RESTful API và Microservices.Có kiến thức/kinh nghiệm về Authentication & Authorization (JWT/OAuth2 hoặc tương đương).Có kinh nghiệm làm việc với SQL Database, thiết kế dữ liệu và tối ưu query.Có kinh nghiệm sử dụng Git; có kiến thức/kinh nghiệm với Docker và CI/CD.Có kinh nghiệm phát triển và xử lý vấn đề trên hệ thống production.| … | chưa |
