...
|---|---|---|---|---|
| Kiến thức | • Là sinh viên năm cuối hoặc đã tốt nghiệp Đại học chưa quá 02 năm, ưu tiên các chuyên ngành Công nghệ thông tin hoặc các chương trình đào tạo liên quan đến lập trình và kỹ thuật phần mềm
 |Có từ 2 năm kinh nghiệm phát triển phần mềm Fullstack hoặc vị trí tương đương.<br>Có kinh nghiệm thực tế phát triển cả Frontend và Backend.<br>Thành thạo ít nhất một công nghệ Frontend như ReactJS, VueJS, Angular.<br>Có kinh nghiệm với một công nghệ Backend như Node.js, PHP/Laravel, .NET/C# hoặc tương đương.<br>Có kinh nghiệm xây dựng và sử dụng RESTful API.<br>Có kinh nghiệm làm việc với MySQL, PostgreSQL, SQL Server hoặc hệ quản trị cơ sở dữ liệu tương đương.<br>Sử dụng tốt Git và quy trình quản lý source code.| … | chưa |
| Kỹ năng | • Nắm vững kiến thức nền tảng về cấu trúc dữ liệu, thuật toán và thành thạo ít nhất một ngôn ngữ lập trình (Java, C++, Python,...)
 | … | … | chưa |
